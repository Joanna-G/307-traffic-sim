	...
	*		intersection.
	*   File Desc: This is the Semi subclass of VehicleMovement.
	*		It handles moving and printing a report for 18-wheelers.
	*   Date: 4/9/17
	*
...
Semi::Semi(eCarType typeEnum, int ID, double startX, double startY, 
 ...
 * implemented here with permission.                                                 *
 /////////////////////////////////////////////////////////////////////////////////////
 */
void Semi::changeSpeed(Road *currentRoad, Intersection *nextIntersection) {
 ...
 * implemented here with permission.                                                 *
 /////////////////////////////////////////////////////////////////////////////////////
 */
void Semi::handleLocationException(eTurnDirection *turnDirection, double *nextX, double *nextY) {
 ...
 * left or right.																	 *
 /////////////////////////////////////////////////////////////////////////////////////
 */
eTurnDirection Semi::decideTurn(Road *currentRoad, Intersection *nextIntersection, eCompassDirection currentDirection) {
	int randNum = rand() % 10;
...
void Semi::printReport() {
	...
	cout << fixed;
	cout << setprecision(1);
	cout << "Vehicle #" << m_iVehicleID << " is an 18-wheeler located at (" << m_dXPos << ", " << m_dYPos << ")." << endl;
