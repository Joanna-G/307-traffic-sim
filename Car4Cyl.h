	...
	*		variables and function prototypes for the 4 Cylinder Car
...
class Car4Cyl : public VehicleMovement
{
...
public:
	Car4Cyl(eCarType typeEnum, int ID, double startX, double startY, eCompassDirection direction, double acc);
	~Car4Cyl();
	void move();
