	...
	*		variables and function prototypes for the Truck subclass
...
class Truck : public VehicleMovement
{
...
public:
	Truck(eCarType typeEnum, int ID, double startX, double startY, eCompassDirection direction, double acc);
	~Truck();
	void move();
