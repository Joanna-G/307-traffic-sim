	...
	*		variables and function prototypes for the 6 Cylinder Car
...
class Car6Cyl : public VehicleMovement
{
...
public:
	Car6Cyl(eCarType typeEnum, int ID, double startX, double startY, eCompassDirection direction, double acc);
	~Car6Cyl();
	void move();
