	...
	*		intersection.
	*   File Desc: This is the 8-Cylinder Car subclass of VehicleMovement.
	*		It handles moving and printing a report for 8-cylinder cars.
	*   Date: 4/9/17
	*
...
Car8Cyl::Car8Cyl(eCarType typeEnum, int ID, double startX, double startY, 
 ...
 * implemented here with permission.                                                 *
 /////////////////////////////////////////////////////////////////////////////////////
 */
void Car8Cyl::changeSpeed(Road *currentRoad, Intersection *nextIntersection) {
 ...
 * implemented here with permission.                                                 *
 /////////////////////////////////////////////////////////////////////////////////////
 */
void Car8Cyl::handleLocationException(eTurnDirection *turnDirection, double *nextX, double *nextY) {
 ...
 * left or right.																	 *
 /////////////////////////////////////////////////////////////////////////////////////
 */
eTurnDirection Car8Cyl::decideTurn(Road *currentRoad, Intersection *nextIntersection, eCompassDirection currentDirection) {
	int randNum = rand() % 10;
...
void Car8Cyl::printReport() {
	...
	cout << fixed;
	cout << setprecision(1);
	cout << "Vehicle #" << m_iVehicleID << " is an 8-cylinder car located at (" << m_dXPos << ", " << m_dYPos << ")." << endl;
