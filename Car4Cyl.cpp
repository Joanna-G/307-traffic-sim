	...
	*		intersection.
	*   File Desc: This is the 4-Cylinder Car subclass of VehicleMovement.
	*		It handles moving and printing a report for 4-cylinder cars.
	*   Date: 4/9/17
	*
...
Car4Cyl::Car4Cyl(eCarType typeEnum, int ID, double startX, double startY, 
 ...
 */
void Car4Cyl::move() {
	double  nextX, nextY, SLmph, SLmps, midptX, midptY, distTravPerSecAC, distCentNextIntAD, distToNextLaneBD, distBeforeTurnBC;
	int newNumLanes;
	Road *tempRoad;
	Road *currentRoad;
	Road *prevRoad;
 ...
 * implemented here with permission.                                                 *
 /////////////////////////////////////////////////////////////////////////////////////
 */
void Car4Cyl::changeSpeed(Road *currentRoad, Intersection *nextIntersection) {
 ...
 * implemented here with permission.                                                 *
 /////////////////////////////////////////////////////////////////////////////////////
 */
void Car4Cyl::handleLocationException(eTurnDirection *turnDirection, double *nextX, double *nextY) {
 ...
 * left or right.																	 *
 /////////////////////////////////////////////////////////////////////////////////////
 */
eTurnDirection Car4Cyl::decideTurn(Road *currentRoad, Intersection *nextIntersection, eCompassDirection currentDirection) {
	int randNum = rand() % 10;
...
void Car4Cyl::printReport() {
	...
	cout << fixed;
	cout << setprecision(1);
	cout << "Vehicle #" << m_iVehicleID << " is a 4-cylinder car located at (" << m_dXPos << ", " << m_dYPos << ")." << endl;
