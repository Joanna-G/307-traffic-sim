	...
	*		intersection.
	*   File Desc: This is the 6-Cylinder Car subclass of VehicleMovement.
	*		It handles moving and printing a report for 6-cylinder cars.
	*   Date: 4/9/17
	*
...
Car6Cyl::Car6Cyl(eCarType typeEnum, int ID, double startX, double startY, 
 ...
 * implemented here with permission.                                                 *
 /////////////////////////////////////////////////////////////////////////////////////
 */
void Car6Cyl::changeSpeed(Road *currentRoad, Intersection *nextIntersection) {
 ...
 * implemented here with permission.                                                 *
 /////////////////////////////////////////////////////////////////////////////////////
 */
void Car6Cyl::handleLocationException(eTurnDirection *turnDirection, double *nextX, double *nextY) {
 ...
 * left or right.																	 *
 /////////////////////////////////////////////////////////////////////////////////////
 */
eTurnDirection Car6Cyl::decideTurn(Road *currentRoad, Intersection *nextIntersection, eCompassDirection currentDirection) {
	int randNum = rand() % 10;
...
void Car6Cyl::printReport() {
	...
	cout << fixed;
	cout << setprecision(1);
	cout << "Vehicle #" << m_iVehicleID << " is a 6-cylinder car located at (" << m_dXPos << ", " << m_dYPos << ")." << endl;
